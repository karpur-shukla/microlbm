...
int main() {
  ...
  std::ofstream reynolds_num_vs_L2_error_csv("./couette_flow_incompressible_RK4/Re_vs_L2__u_wall_E-29.csv");
  ...
  for (int current_pt_in_decade = 0; current_pt_in_decade < 17; current_pt_in_decade++) {
    ...
    u_wall_top = (u_wall_top_reference + current_pt_in_decade/2.0) * 1.0e-29;
    ...
    std::string ux_csv_path = "./couette_flow_incompressible_RK4/ux_at_Re/";
    std::string ux_csv_filename = "ux_Re_" + Reynolds_num_string_for_filename;
    std::string rho_csv_path = "./couette_flow_incompressible_RK4/rho_at_Re/";
    ...
    //std::ofstream largest_diff_txt("./couette_flow_incompressible_RK4/diff.txt");
    ...
    //while (largest_diff_in_simulated_ux_between_timesteps > 1.0e-15) {
      ...
      std::string Reynolds_num_string_for_filename = std::to_string(Reynolds_num);
      std::string curr_ux_csv_path = "./couette_flow_incompressible_RK4/ux_profiles_for_testing_difference/";

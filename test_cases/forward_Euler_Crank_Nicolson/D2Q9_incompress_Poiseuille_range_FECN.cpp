 ...
 * (which contains the time steppers), D2Q9_rect_incompress.cpp (which contains functions used for incompressible LB simulations), and D2Q9_Poiseuille.cpp (which contains functions used for 2D
 * Poiseuille flow problems specifically). */


 /* Here, we include all of the packages necessary for the code. We also include D2Q9_rect.cpp, D2Q9_rect_time_step.cpp, D2Q9_rect_incompress.cpp, and D2Q9_Poiseuille.cpp. */
#include <iostream>
#include <iomanip>
#include <fstream>
#include <sstream>
...
int main() {
  ...
  std::ofstream reynolds_num_vs_L2_error_csv("./poiseuille_flow_incompressible_FECN/Re_vs_L2__u_max_cent_E-3.csv");
  ...
  for (int current_pt_in_decade = 0; current_pt_in_decade < 17; current_pt_in_decade++) {
    ...
    std::string ux_csv_path = "./poiseuille_flow_incompressible_FECN/ux_at_Re/";
    std::string ux_csv_filename = "ux_Re_" + Reynolds_num_string_for_filename;
    std::string rho_csv_path = "./poiseuille_flow_incompressible_FECN/rho_at_Re/";
    ...
    //std::ofstream largest_diff_txt("./poiseuille_flow_incompressible_FECN/diff.txt");
    ...
    //while (largest_diff_in_simulated_ux_between_timesteps > 1.0e-15) {
      ...
      std::string Reynolds_num_string_for_filename = std::to_string(Reynolds_num);
      std::string curr_ux_csv_path = "./poiseuille_flow_incompressible_FECN/ux_profiles_for_testing_difference/";
